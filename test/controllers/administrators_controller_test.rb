...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { password: @administrator.password, user_name: @administrator.user_name } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { password: @administrator.password, user_name: @administrator.user_name } }
